...
var lang = {
  ...
  a_monitor_xml: "Monitoruj XML",
  a_monitor_json: "Monitoruj JSON",
  a_monitor_pdf: "Monitoruj PDF",
  ...
  l_page_options: "Opcje strony",
  l_include_style: "Do\u0142\u0105cz style strony",
  l_dynamic: "W\u0142\u0105cz JavaScript",
  l_delay: "Poczekaj na czas trwania",
  l_delay_info: "Czekaj czas na za\u0142adowanie strony przed sprawdzeniem zmian",
  l_dynamic_info: "W\u0142\u0105cz JavaScript \u0142adowanie tre\u015Bci dynamicznej",
  l_include_style_info: "Wy\u0142\u0105cz, aby zignorowa\u0107 style strony do szybszych kontroli",
  ...
  l_incognito_info: "Uruchom monitor w karcie incognito (Dost\u0119pne tylko w aplikacji desktopowej)",
  l_js: "JavaScript",
  l_label: "Etykieta",
  ...
  m_check_web_only: `Lokalne monitory nie mog\u0105 by\u0107 uruchamiane z aplikacji internetowej. Prosz\u0119 prze\u0142\u0105czy\u0107 si\u0119 na list\u0119 obserwowanych %s, aby je uruchomi\u0107`,
  m_clear_browser_data: "Wyczy\u015B\u0107 dane przegl\u0105darki",
  ...
  m_minimize_to_tray: "Minimalizuj do zasobnika przy zamkni\u0119ciu",
  m_never: "Nigdy",
  ...
  l_adblocker: "Blokuj reklamy i pliki cookie",
  l_adblocker_info: "W\u0142\u0105cz blokowanie reklam i baner\xF3w cookie",
  ...
  l_sieve_to_compare: "Monitor do por\xF3wnania",
  l_sieve_to_compare_with: "Monitor do por\xF3wnania z",
  ...
  l_not_match_any_previous_text: "nie pasuje do poprzedniego tekstu",
  l_text_del: "Tekst usuni\u0119ty",
  l_net_added_text: "Tekst dodany netto",
  l_net_deleted_text: "Tekst dodany netto",
  ...
  l_installed: "Zainstalowany",
  a_download: "Pobierz",
  a_add_to: "Dodaj Do %s",
  l_extension: "Rozszerzenie przegl\u0105darki",
  l_desktop: "Aplikacja na komputer",
  a_go: "Id\u017A",
  a_back: "Wstecz",
  a_skip: "Pomi\u0144",
  l_unlimited: "Nieograniczony",
  l_minutes: "Minuty",
  l_onboarding_welcome_title: "Super, \u017Ce jeste\u015B tutaj!",
  m_onboarding_welcome_1: "Sprawiamy, \u017Ce \u015Bledzenie informacji w sieci to bu\u0142ka z mas\u0142em.",
  m_onboarding_welcome_2: "Zmiany cen? Mamy na to oko.",
  m_onboarding_welcome_3: "Obserwowanie konkurencji? Proste jak bu\u0142ka z mas\u0142em.",
  m_onboarding_welcome_4: "Potrzebujesz wiedzie\u0107, kiedy zawarto\u015B\u0107 si\u0119 zmienia? \u017Baden problem.",
  m_onboarding_welcome_5: "Prosta konfiguracja, pot\u0119\u017Cne funkcje, aktualizacje na czas.",
  m_onboarding_welcome_6: "Wszystko w czasie rzeczywistym, bezpo\u015Brednio z twojej przegl\u0105darki.",
  m_onboarding_welcome_7: "Wi\u0119c, zaczynamy?",
  l_onboarding_platforms_title: "\u015Aled\u017A zmiany z pr\u0119dko\u015Bci\u0105 \u015Bwiat\u0142a, bez obaw",
  m_onboarding_platforms_benefits: "Korzy\u015Bci z korzystania z rozszerzenia/aplikacji na komputer:",
  m_onboarding_platforms_benefits_1: "Szybsze kontrole",
  m_onboarding_platforms_benefits_2: "Nieograniczone lokalne kontrole",
  m_onboarding_platforms_benefits_3: "Ustaw monitory na r\xF3\u017Cnych urz\u0105dzeniach",
  m_onboarding_platforms_benefits_4: "Powiadomienia d\u017Awi\u0119kowe",
  a_save_and_next: "Zapisz & Dalej",
  m_onboarding_create_monitor_title: "Utw\xF3rz sw\xF3j pierwszy monitor",
  m_onboarding_create_monitor_info_1: "Kliknij 'Id\u017A' lub wprowad\u017A wybrany adres URL. Po za\u0142adowaniu strony kliknij 'Zapisz i dalej'.",
  m_onboarding_create_monitor_info_2: "Monitoruj strony internetowe, \u015Bled\u017A zmiany w plikach PDF, obserwuj aktualizacje w kana\u0142ach RSS lub punktach ko\u0144cowych JSON, mo\u017Cesz nawet monitorowa\u0107 dost\u0119pno\u015B\u0107 strony internetowej",
  m_onboarding_create_monitor_exists: "Ju\u017C utworzy\u0142e\u015B jeden monitor do nauki obs\u0142ugi, usu\u0144 go, zanim utworzysz nowy",
  m_onborading_free_trial_title: "Wypr\xF3buj za darmo funkcje Premium!",
  m_onboarding_free_trial: "Odblokuj pe\u0142ny potencja\u0142 Distill z naszym <strong>7-dniowym darmowym</strong> okresem pr\xF3bnym. Skorzystaj z ulepszonych mo\u017Cliwo\u015Bci monitorowania i zdob\u0105d\u017A praktyczne wnioski.",
  m_onboarding_free_trial_info: "W ramach darmowego okresu pr\xF3bnego masz dost\u0119p do funkcji premium:",
  m_onboarding_free_trial_info_1: "Nieograniczone powiadomienia push",
  m_onboarding_free_trial_info_2: "Makra do automatyzacji krok\xF3w, takich jak wype\u0142nianie formularzy i klikanie",
  m_onboarding_free_trial_info_3: "Powiadomienia na Slack, Discord i Webhook",
  m_onboarding_free_trial_info_4: "Szybsze sprawdzanie chmury i monitorowanie 24x7",
  l_start_free_trial: "Rozpocznij darmowy okres pr\xF3bny",
  l_subscribed_to_free_trial: "Pomy\u015Blnie zarejestrowano do darmowego okresu pr\xF3bnego!",
  m_onboarding_free_trial_cond_1: "* W celach weryfikacyjnych na twojej karcie kredytowej zostanie pobrana op\u0142ata autoryzacyjna w wysoko\u015Bci 1 dolara. Zostanie ona zwr\xF3cona w ci\u0105gu 7 dni.",
  m_onboarding_free_trial_cond_2: "* Po zako\u0144czeniu darmowego okresu pr\xF3bnego przejdziesz na <a href='https://distill.io/pricing/' target='_blank'>plan Startowy</a>.",
  m_continue_without_trial: "Kontynuowa\u0107 bez darmowego okresu pr\xF3bnego?",
  m_without_trial_warning: `Premiumowe monitory, kt\xF3re utworzy\u0142e\u015B, nie s\u0105 zawarte w naszym darmowym planie, a kontynuowanie spowoduje ich usuni\u0119cie.
    Aby utrzyma\u0107 je aktywne, wypr\xF3buj nasz darmowy okres pr\xF3bny lub wybierz jedn\u0105 z naszych p\u0142atnych subskrypcji.`,
  l_continue_with_free_plan: "Kontynuuj z darmowym planem",
  l_monitors: "Monitory",
  l_push: "Powiadomienia Push",
  l_macros: "Makra",
  l_min_cloud_interval: "Minimalny odst\u0119p kontroli w chmurze",
  m_onboarding_whats_next_title: "Co dalej?",
  m_onboarding_whats_next_info_1: "Zainstaluj <strong>aplikacj\u0119 Distill</strong>, aby wy\u015Bwietla\u0107 aktualizacje i otrzymywa\u0107 powiadomienia push w dowolnym miejscu.",
  m_onboarding_whats_next_info_2: "To dopiero pocz\u0105tek, jest jeszcze wiele do odkrycia:",
  l_import_export: "Import/Eksport",
  l_download_all_monitors: "Pobierz wszystkie monitory",
  l_download_selected_monitors: "Pobierz wybrane monitory",
  m_import_export_info: "Przeno\u015B monitory z jednego urz\u0105dzenia na drugie.",
  m_conditions_info: "Otrzymuj powiadomienia tylko wtedy, gdy spe\u0142nione s\u0105 skonfigurowane kryteria",
  m_macros_info: "Zapisuj dzia\u0142ania i odtwarzaj je podczas wykonywania kontroli",
  m_watchlist_info: "Przegl\u0105daj, dodawaj i zarz\u0105dzaj wszystkimi swoimi monitorami"
};
