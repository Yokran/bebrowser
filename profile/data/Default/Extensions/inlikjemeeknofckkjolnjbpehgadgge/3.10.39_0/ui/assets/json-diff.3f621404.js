...
import { b as generateTree, c as getChanges, d as ChangeType } from "./AppLocal.d8abe63b.js";
...
class JsonDiff {
  ...
  async render(diff, renderOpts = {}) {
    const { diffNodeToHTML } = await __vitePreload(() => import("./jsondiff-to-html.09f820db.js"), true ? ["assets/jsondiff-to-html.09f820db.js","assets/service.04a32097.js","assets/index-default.0d44a930.js","assets/html-components.f4de8727.js","assets/AppLocal.d8abe63b.js","assets/AppLocal.81350a2b.css","assets/index.21aef151.js","assets/json-parser.7cb2f04e.js","assets/json-parser.f1628d7e.css","assets/Message.fcbba7db.js","assets/SchemaKeyTree.96209fd8.js","assets/SchemaKeyTree.9a96e0c5.css","assets/Card.0607fce4.js","assets/utils.fb792079.js"] : void 0);
    return await diffNodeToHTML(diff, renderOpts);
  }
  async renderEmail(diff, { emailOpts } = {}) {
    const { snipJsonDiff, removeAdditions, removeDeletions, cloneJsonDiff } = await __vitePreload(() => import("./AppLocal.d8abe63b.js").then(function(n) {
      return n.e;
    }), true ? ["assets/AppLocal.d8abe63b.js","assets/AppLocal.81350a2b.css","assets/index.21aef151.js","assets/json-parser.7cb2f04e.js","assets/json-parser.f1628d7e.css","assets/service.04a32097.js","assets/Message.fcbba7db.js","assets/SchemaKeyTree.96209fd8.js","assets/SchemaKeyTree.9a96e0c5.css","assets/Card.0607fce4.js"] : void 0);
    let { highlighted = true, mode = "SPLIT", snipped = true } = emailOpts;
    if (snipped) {
      snipJsonDiff(diff);
    }
    const { body } = await __vitePreload(() => import("./html-components.f4de8727.js"), true ? ["assets/html-components.f4de8727.js","assets/AppLocal.d8abe63b.js","assets/AppLocal.81350a2b.css","assets/index.21aef151.js","assets/json-parser.7cb2f04e.js","assets/json-parser.f1628d7e.css","assets/service.04a32097.js","assets/Message.fcbba7db.js","assets/SchemaKeyTree.96209fd8.js","assets/SchemaKeyTree.9a96e0c5.css","assets/Card.0607fce4.js"] : void 0);
    switch (mode) {
      case "NONE":
      ...
      case "SPLIT":
        const { getSplitView } = await __vitePreload(() => import("./jsondiff-to-html.09f820db.js"), true ? ["assets/jsondiff-to-html.09f820db.js","assets/service.04a32097.js","assets/index-default.0d44a930.js","assets/html-components.f4de8727.js","assets/AppLocal.d8abe63b.js","assets/AppLocal.81350a2b.css","assets/index.21aef151.js","assets/json-parser.7cb2f04e.js","assets/json-parser.f1628d7e.css","assets/Message.fcbba7db.js","assets/SchemaKeyTree.96209fd8.js","assets/SchemaKeyTree.9a96e0c5.css","assets/Card.0607fce4.js","assets/utils.fb792079.js"] : void 0);
