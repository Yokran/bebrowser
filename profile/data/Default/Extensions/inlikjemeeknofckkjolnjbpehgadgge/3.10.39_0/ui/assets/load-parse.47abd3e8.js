import { l as lib, r as render$1, e as escapeAttribute, a as escapeText } from "./index.821ff0ec.js";
...
class Text extends DataNode {
  constructor() {
    super(...arguments);
    this.type = lib.ElementType.Text;
  }
  get nodeType() {
    return 3;
  }
...
class Comment extends DataNode {
  constructor() {
    super(...arguments);
    this.type = lib.ElementType.Comment;
  }
  get nodeType() {
    return 8;
  }
...
class ProcessingInstruction extends DataNode {
  constructor(name, data2) {
    super(data2);
    this.name = name;
    this.type = lib.ElementType.Directive;
  }
  get nodeType() {
    return 1;
  }
...
class CDATA extends NodeWithChildren {
  constructor() {
    super(...arguments);
    this.type = lib.ElementType.CDATA;
  }
  get nodeType() {
    return 4;
  }
...
class Document extends NodeWithChildren {
  constructor() {
    super(...arguments);
    this.type = lib.ElementType.Root;
  }
  get nodeType() {
    return 9;
  }
...
class Element extends NodeWithChildren {
  constructor(name, attribs, children2 = [], type = name === "script" ? lib.ElementType.Script : name === "style" ? lib.ElementType.Style : lib.ElementType.Tag) {
    super(children2);
    this.name = name;
...
class DomHandler {
  ...
  onopentag(name, attribs) {
    const type = this.options.xmlMode ? lib.ElementType.Tag : void 0;
...
function innerText(node) {
  ...
  if (hasChildren(node) && (node.type === lib.ElementType.Tag || isCDATA(node))) {
...
function getLoad(parse2, render2) {
  return function load2(content, options, isDocument2 = true) {
    ...
    function initialize(selector, context, root2 = initialRoot, opts) {
      ...
      let search = selector;
      const searchContext = context ? typeof context === "string" ? isHtml(context) ? new LoadedCheerio([parse2(context, options2, false, null)], rootInstance, options2) : (search = `${context} ${search}`, rootInstance) : isCheerio(context) ? context : new LoadedCheerio(Array.isArray(context) ? context : [context], rootInstance, options2) : rootInstance;
      if (!searchContext)
        return instance;
...
export { contains as c, load as l, merge as m };
