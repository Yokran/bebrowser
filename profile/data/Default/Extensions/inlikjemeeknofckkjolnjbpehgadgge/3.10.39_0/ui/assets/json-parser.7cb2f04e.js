...
async function loadModule(locale2) {
  switch (locale2) {
    case "de":
      return await __vitePreload(() => import("./lang.591bb39f.js"), true ? ["assets/lang.591bb39f.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "en-US":
      return await __vitePreload(() => Promise.resolve().then(function() {
        return lang;
      }), true ? void 0 : void 0);
    case "es":
      return await __vitePreload(() => import("./lang.f6ab3b56.js"), true ? ["assets/lang.f6ab3b56.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "fr":
      return await __vitePreload(() => import("./lang.ce4d69f7.js"), true ? ["assets/lang.ce4d69f7.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "it":
      return await __vitePreload(() => import("./lang.f17a3de0.js"), true ? ["assets/lang.f17a3de0.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "ja":
      return await __vitePreload(() => import("./lang.a252359d.js"), true ? ["assets/lang.a252359d.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "pl":
      return await __vitePreload(() => import("./lang.7b21b7ea.js"), true ? ["assets/lang.7b21b7ea.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "pt":
      return await __vitePreload(() => import("./lang.202fe7de.js"), true ? ["assets/lang.202fe7de.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "ru":
      return await __vitePreload(() => import("./lang.9920b079.js"), true ? ["assets/lang.9920b079.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "sr":
      return await __vitePreload(() => import("./lang.a2fa6f67.js"), true ? ["assets/lang.a2fa6f67.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    case "zh":
      return await __vitePreload(() => import("./lang.8202c1be.js"), true ? ["assets/lang.8202c1be.js","assets/service.04a32097.js","assets/index.21aef151.js"] : void 0);
    default:
...
var Sieve = Model.extend({
  ...
  async fetchMacro() {
    ...
    if (macro_id) {
      return await Api.api(`/macros/${macro_id}`, "GET");
    }
...
async function importPosthog() {
  return await __vitePreload(() => import("./module.no-external.0e47f8cc.js"), true ? [] : void 0);
}
const PHEvents = {
  ADD_MONITOR: {
...
export { qs as $, Api as A, querystring as B, C$1 as C, push$1 as D, Editor as E, FormModel as F, Base$1 as G, html as H, ID as I, getVar as J, getDef as K, defs as L, Model$1 as M, NodePart as N, And as O, Or as P, SingleRule as Q, Router as R, Supports as S, TXT as T, hasNumeric as U, View as V, RuleToTypeMap as W, formatInterval as X, getShortDisplayText as Y, Macros as Z, render as _, removeNodes as a, Params as a$, Macro as a0, formatTimeV2 as a1, location as a2, trackEvent as a3, PHEvents as a4, jsonType as a5, isArrayOfObject as a6, ParsedPropertyName as a7, sanitize as a8, isPrimitiveType as a9, ADBLOCKER_ID as aA, V1 as aB, V2 as aC, formatLogTime as aD, SieveDataCollection as aE, getCurrentRoute as aF, PHEventCategories as aG, mustMatchRegex as aH, verifyEnum as aI, SieveFormModel as aJ, CrawlerJob as aK, Crawler as aL, JSONEdit as aM, getBasePath as aN, pop as aO, Crawlers as aP, JobStates as aQ, getDuration as aR, CrawlerJobs as aS, replace$1 as aT, Self as aU, Core as aV, identifyUser as aW, updateTeam as aX, updateRoute as aY, loadLang as aZ, withWindow as a_, isPrimitive as aa, isArrayOfPrimitives as ab, initStores as ac, jsonParser as ad, getInterval as ae, _typeof as af, getUTCWeekYear as ag, startOfUTCWeek as ah, startOfUTCISOWeek as ai, requiredArgs as aj, toDate as ak, getUTCWeek as al, toInteger as am, getUTCISOWeek as an, getDefaultOptions as ao, defaultLocale as ap, longFormatters$1 as aq, isProtectedWeekYearToken as ar, throwProtectedError as as, isProtectedDayOfYearToken as at, subMilliseconds as au, getTimezoneOffsetInMilliseconds as av, assign$1 as aw, isValid as ax, getNameFromURL as ay, EXT_ID_PROPS as az, Msg as b, Types as b0, setValue as b1, MESSAGES as b2, commonjsGlobal as b3, getDefaultExportFromCjs as b4, createMarker as c, directive as d, createFieldStore as e, TYPES as f, FieldList as g, register as h, derived as i, ModelClient as j, i18n as k, AttrModel as l, route as m, SieveActionDescList as n, isQuotaAvailable as o, params as p, cannotBeLessThan as q, reparentNodes as r, base$1 as s, formatTime as t, urlCfg as u, toISOString as v, writable as w, isStaticDatasource as x, types as y, format as z };
